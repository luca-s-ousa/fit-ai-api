...
- **OBRIGATÓRIO**: **SEMPRE** inclua `tags` e `summary` no schema de **TODAS** as rotas, sem exceção. Isso é crucial para a organização e geração automática da documentação via Swagger/OpenAPI.
