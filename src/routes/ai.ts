...
export const aiRoutes = async (app: FastifyInstance) => {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    handler: async (request: FastifyRequest, reply: FastifyReply) => {
      const messages = (request.body as z.infer<typeof AiBodySchema>)
      ...
      const result = streamText({
        ...
        tools: {
          ...
          getUserTrainData: tool({
            description:
              "Busca os dados de perfil e medidas do usuário autenticado (peso, altura, idade, % de gordura). Sempre chamar antes de qualquer interação.",
          ...
          updateUserTrainData: tool({
            description:
              "Cria ou atualiza os dados de perfil e medidas do usuário autenticado.",
            inputSchema: z.object({
              weightInGrams: z
                .number()
                .int()
              ...
              bodyFatPercentage: z
                ...
                .max(100)
                .describe(
                  "Percentual de gordura corporal, inteiro de 0 a 100 (ex: 15 para 15%)",
                ),
            }),
            execute: async (input: {
          ...
          createWorkoutPlan: tool({
            description:
              "Cria um novo plano de treino completo com exatamente 7 dias (MONDAY a SUNDAY). Dias de descanso devem ter isRest: true, exercises: [] e estimatedDurationInSeconds: 0.",
            inputSchema: z.object({
              name: z
                .string()
                .trim()
              ...
              workoutDays: z
                .array(
                  z.object({
                    name: z
                      ...
                      .min(1)
                      .describe(
                        "Nome descritivo do dia (ex: 'Superior A - Peito e Costas', 'Descanso')",
                      ),
                    weekDay: z
                      .enum(weekDay)
                      .describe(
                ...
                .length(7)
                .describe(
                  "Array com exatamente 7 dias de treino (MONDAY a SUNDAY, nessa ordem)",
                ),
            }),
            // @ts-ignore
            execute: async (input: {
